...
project = u'Kmee Odoo Dev Training'
copyright = u'2016, Luis Felipe Miléo'
...
htmlhelp_basename = 'KmeeOdooDevTraining'
...
latex_documents = [
  ('index', 'KmeeOdooDevTraining.tex', u'Kmee Odoo Dev Training',
